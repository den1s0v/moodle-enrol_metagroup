...
$string['defaultgroupnametext'] = '{$a->name} (связ.) {$a->increment}';
 $string['defaultenrolnametext'] = '{$a->method} («{$a->target_group}» из «{$a->source_group}» в «{$a->source_course}»)';
...
$string['limittoenrolled_help'] = 'При выборе курса для создания связи предлагать только те курсы, на которые пользователь зачислен явно ().';
