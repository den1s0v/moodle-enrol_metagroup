...
$observers = array(
    ...
    array(
        ...
        'callback'    => 'enrol_metagroup_observer::role_assigned',
    ),
    array(
        'eventname'   => '\core\event\role_unassigned',
        'callback'    => 'enrol_metagroup_observer::role_unassigned',
    ),
    array(
        'eventname'   => '\core\event\course_deleted',
        'callback'    => 'enrol_metagroup_observer::course_deleted',
    ),
    array(
    ...
    array(
        ...
        'callback' => 'enrol_metagroup_observer::group_deleted',
    ),
);
